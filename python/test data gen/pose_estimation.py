...
#	print(test)
	...
	#print("offsets")
	#print(offsets[3][2][0])
	#print(offsets[3][2][17])
	#print(offsets.shape[0])
	#print(offsets.shape[1])
	#print(offsets.shape[2])
	
	#print(heatmaps.shape[0])
	#print(heatmaps.shape[1])
	...
	for ki in range(0, num_keypoints ):
		...
		#print(offsets[y,x,ki])
		#print(offsets[y,x,num_keypoints+ki])
		#print("x")
		#print(x)
		#print("y")
		#print(y)
...
def estimate_images(image_directory, model_path):
	...
	for chosen_image in images:
		...
		#print("image_input data ")
		#print(input_details[0])
		
	
		#cv2.imwrite(r'C:\Users\koend\Desktop\testing\test data gen\data_set\test.jpg', image)
		...
		#for i in range(0, 9):
			#for j in range(0, 9):
				#for k in range(0, 34):
					#print(image_offset[i][j][k])
		
	#	print("image output data ")
		#print(interpreter.get_output_details())
	#	print(image_output_data)
