...
public class DatabaseData implements Data {
    ...
    //appDatabase File path to the JSON file on disk.
    ...
    //Implements Data's interface function for retrieving the number of body parts using a hardcoded enum.
    ...
    //Implements Data's interface for setting the newComponentValue_X component of a coordinate.
    public void setX(long frame, body_part bp, double newComponentValue_X) {
        NNCoordinate current = this.nnVideoDAO.getCoordinates(frame,bp.ordinal(),
                this.currentSession.id);
        current.x = newComponentValue_X;
    ...
    public void setY(long frame, body_part bp, double newComponentValue_Y) {
        NNCoordinate current = this.nnVideoDAO.getCoordinates(frame,bp.ordinal(),
                this.currentSession.id);
        current.y = newComponentValue_Y;
        NNCoordinateDAO dao = this.appDatabase.nnCoordinateDAO();
        dao.update(current);
    }
}